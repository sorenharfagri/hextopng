...
// Архитектура не из простых, алгоритмы можно оптимизировать, число массивов сократить либо же вынести их в отдельный модуль.
// Решения принимались исходя из цели выполнить задание в сжатые сроки.
